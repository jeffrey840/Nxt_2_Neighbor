    ...
    fetch('https://zillow-com1.p.rapidapi.com/propertyExtendedSearch?location=houston%2C%20Tx&page=1&status_type=RecentlySold&home_type=Houses&sort=Homes_for_You', options)
        ...
        .then(data => {
            ...
            let html = `
                          ...
                          <div class="card-body">
                          <h5 class="card-title">SAVED HOMES</h5>
                          <p class="card-text">${data.props[11].address}</p>
                          <p class="card-text">${data.props[11].propertyType}</p>
                          <a href="#" class="btn btn-primary">DELETE</a>
                          </div>
                          </div>

                          <div class="card" style="width: 18rem;">
                          <img class="card-img-top" src="${data.props[12].imgSrc}" alt="Card image cap">
                          <div class="card-body">
                          <h5 class="card-title">SAVED HOMES</h5>
                          <p class="card-text">${data.props[12].address}</p>
                          <p class="card-text">${data.props[12].propertyType}</p>
                          <a href="#" class="btn btn-primary">DELETE</a>
                          </div>
                          </div>`
