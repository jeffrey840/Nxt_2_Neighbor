...
//                .deleteCookies("JSESSIONID")// append a query string value
                ...
                .requestMatchers("/", "/sign-up","/listings", "/interests", "listings/interests-form", "/listings/interests", "/js/**","/css/**","/img/**", "/contact-us", "/about-us") // anyone can see the home and the ads pages
                .permitAll()
